...
{
	// Могут посылаться лишние пути на удаление, подходящие под excludeCriterias. Сервер их проигнорирует, т.к. таких файлов нет на сервере.
	public static MemoryStream CreateZipByUpdates(
		string pathToFolder,
		ICollection<CourseUpdate> courseUpdates,
