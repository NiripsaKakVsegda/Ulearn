...
namespace uLearn
{
	...
	public class Lesson_ShouldDeserialize
	{
		...
		public void SimpleMdBlock()
		{
			...
			blocks.Should().BeEquivalentTo(new SlideBlock[] { new MarkdownBlock("asd") });
		}
		...
		public void SeveralMdBlocks()
		{
			...
			blocks.Should().BeEquivalentTo(new SlideBlock[] { new MarkdownBlock("1"), new MarkdownBlock("2") });
		}
		...
		public void MixedContentInsideMd()
		{
			...
			blocks.Should().BeEquivalentTo(new SlideBlock[] { new MarkdownBlock("1"), new CodeBlock("2", Language.CSharp), new MarkdownBlock("3") });
		}
		...
		public void OtherTypesOfBlocksAreOK()
		{
			...
			blocks.Should().BeEquivalentTo(new SlideBlock[] { new MarkdownBlock("1"), new CodeBlock("2", Language.JavaScript), new YoutubeBlock("sdfsdfsdf") });
		}
		...
		public void InstructorNotesInsideMd()
		{
			...
			blocks.Should().BeEquivalentTo(new SlideBlock[] { new MarkdownBlock("1"), new MarkdownBlock("secret") { Hide = true }, new MarkdownBlock("2"), new CodeBlock("3", Language.JavaScript), new MarkdownBlock("4") });
		}
