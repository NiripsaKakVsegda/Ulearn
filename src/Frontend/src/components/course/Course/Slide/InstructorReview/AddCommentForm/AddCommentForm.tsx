...
import SampleReviewCommentWrapper
	from "../../Blocks/Exercise/ReviewsBlock/SampleReviewCommentWrapper/SampleReviewCommentWrapper";
	...
	render = (): React.ReactElement => {
		...
		return (
			<div ref={ this.wrapper } className={ styles.wrapper } style={ style }>
				<XIcon16Regular className={ styles.closeFormButton } onClick={ onClose }/>
	...
	renderTextareaSection = (comment: string, canBeAddedToFavourite: boolean): React.ReactElement => (
		<div className={ styles.addCommentSection }>
			...
			<MarkdownEditor
				...
				hideDescription
				lengthCounter={ comment.length > reviewPolicyChecker.maxReviewLength
					? reviewPolicyChecker.maxReviewLength
					: undefined }
		...
		if(c.overextended) {
			return (
				<li key={ id } ref={ c.ref }>
					{ icon }
					<Hint
						pos={ "right middle" } maxWidth={ this.maxCommentHintWidth }
