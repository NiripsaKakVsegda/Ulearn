...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 4136), Tuple.Create("\"", 4243)
, Tuple.Create(Tuple.Create("", 4144), Tuple.Create("quiz-block__is-question__title", 4144), true)
, Tuple.Create(Tuple.Create(" ", 4174), Tuple.Create<System.Object, System.Int32>( string.IsNullOrEmpty(mark) || model.DebugView ? "" : "with-mark"
, 4175), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 4286), Tuple.Create("\"", 4299)
, Tuple.Create(Tuple.Create("", 4294), Tuple.Create<System.Object, System.Int32>(mark
, 4294), false)
);

WriteAttributeTo(__razor_helper_writer, "style", Tuple.Create(" style=\"", 4300), Tuple.Create("\"", 4314)
, Tuple.Create(Tuple.Create("", 4308), Tuple.Create<System.Object, System.Int32>(style
, 4308), false)
);
...
WriteAttributeTo(__razor_helper_writer, "max", Tuple.Create(" max=\"", 4947), Tuple.Create("\"", 4968)
, Tuple.Create(Tuple.Create("", 4953), Tuple.Create<System.Object, System.Int32>(block.MaxScore
, 4953), false)
);

WriteAttributeTo(__razor_helper_writer, "name", Tuple.Create(" name=\"", 4969), Tuple.Create("\"", 5001)
, Tuple.Create(Tuple.Create("", 4976), Tuple.Create("quiz__score__", 4976), true)
                            , Tuple.Create(Tuple.Create("", 4989), Tuple.Create<System.Object, System.Int32>( block.Id
, 4989), false)
);

WriteAttributeTo(__razor_helper_writer, "value", Tuple.Create("\r\n\t\t\t\t\t\tvalue=\"", 5002), Tuple.Create("\"", 5113)
, Tuple.Create(Tuple.Create("", 5017), Tuple.Create<System.Object, System.Int32>( context.ManualChecking.IsChecked ? context.UserScores.GetOrDefault(block.Id).ToString() : ""
, 5017), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 6337), Tuple.Create("\"", 6421)
, Tuple.Create(Tuple.Create("", 6345), Tuple.Create("expandable-code", 6345), true)
, Tuple.Create(Tuple.Create(" ", 6360), Tuple.Create<System.Object, System.Int32>( linesCount > linesCountToShow ? "collapsed" : "expanded"
, 6361), false)
);
...
WriteAttributeTo(__razor_helper_writer, "href", Tuple.Create(" href=\"", 8851), Tuple.Create("\"", 8907)
, Tuple.Create(Tuple.Create("", 8858), Tuple.Create("https://docs.google.com/document/d/", 8858), true)
                                , Tuple.Create(Tuple.Create("", 8893), Tuple.Create<System.Object, System.Int32>(googleDocLink
, 8893), false)
);
...
WriteAttributeTo(__razor_helper_writer, "href", Tuple.Create(" href=\"", 9293), Tuple.Create("\"", 9349)
, Tuple.Create(Tuple.Create("", 9300), Tuple.Create("https://docs.google.com/document/d/", 9300), true)
                             , Tuple.Create(Tuple.Create("", 9335), Tuple.Create<System.Object, System.Int32>(googleDocLink
, 9335), false)
);
...
WriteAttributeTo(__razor_helper_writer, "src", Tuple.Create(" src=\"", 9731), Tuple.Create("\"", 9746)
, Tuple.Create(Tuple.Create("", 9737), Tuple.Create<System.Object, System.Int32>(imageUrl
, 9737), false)
);

WriteAttributeTo(__razor_helper_writer, "alt", Tuple.Create(" alt=\"", 9747), Tuple.Create("\"", 9762)
, Tuple.Create(Tuple.Create("", 9753), Tuple.Create<System.Object, System.Int32>(imageUrl
, 9753), false)
);
...
WriteTo(__razor_helper_writer, new HtmlString(block.GetContent(context.BaseUrlApi)));
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 11433), Tuple.Create("\"", 11486)
, Tuple.Create(Tuple.Create("", 11441), Tuple.Create("quiz-block-mark", 11441), true)
, Tuple.Create(Tuple.Create(" ", 11456), Tuple.Create<System.Object, System.Int32>(inputType
, 11457), false)
, Tuple.Create(Tuple.Create(" ", 11467), Tuple.Create<System.Object, System.Int32>(inputType
, 11468), false)
, Tuple.Create(Tuple.Create("", 11478), Tuple.Create("-default", 11478), true)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 11487), Tuple.Create("\'", 11519)
, Tuple.Create(Tuple.Create("", 11492), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 11492), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 12938), Tuple.Create("\"", 12973)
, Tuple.Create(Tuple.Create("", 12946), Tuple.Create("quiz__statistics", 12946), true)
, Tuple.Create(Tuple.Create(" ", 12962), Tuple.Create<System.Object, System.Int32>(className
, 12963), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 12974), Tuple.Create("\"", 13058)
, Tuple.Create(Tuple.Create("", 12982), Tuple.Create("Этот", 12982), true)
, Tuple.Create(Tuple.Create(" ", 12986), Tuple.Create("вариант", 12987), true)
, Tuple.Create(Tuple.Create(" ", 12994), Tuple.Create("выбирают", 12995), true)
, Tuple.Create(Tuple.Create(" ", 13003), Tuple.Create("в", 13004), true)
           , Tuple.Create(Tuple.Create(" ", 13005), Tuple.Create<System.Object, System.Int32>( model.QuestionAnswersFrequency[item.Id]
, 13006), false)
, Tuple.Create(Tuple.Create("", 13049), Tuple.Create("%", 13049), true)
, Tuple.Create(Tuple.Create(" ", 13050), Tuple.Create("случаев", 13051), true)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 13296), Tuple.Create("\"", 13314)
, Tuple.Create(Tuple.Create("", 13304), Tuple.Create<System.Object, System.Int32>(itemClass
, 13304), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 13315), Tuple.Create("\"", 13329)
, Tuple.Create(Tuple.Create("", 13323), Tuple.Create<System.Object, System.Int32>(title
, 13323), false)
);

WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 13330), Tuple.Create("\"", 13372)
, Tuple.Create(Tuple.Create("", 13336), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + item.Id
, 13336), false)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 15644), Tuple.Create("\'", 15675)
, Tuple.Create(Tuple.Create("", 15649), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock"
, 15649), false)
);

WriteAttributeTo(__razor_helper_writer, "maxlength", Tuple.Create(" maxlength=\"", 15676), Tuple.Create("\"", 15722)
         , Tuple.Create(Tuple.Create("", 15688), Tuple.Create<System.Object, System.Int32>(QuizController.MaxFillInBlockSize
, 15688), false)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\"", 17585), Tuple.Create("\"", 17617)
, Tuple.Create(Tuple.Create("", 17590), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 17590), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 17828), Tuple.Create("\"", 17850)
, Tuple.Create(Tuple.Create("", 17836), Tuple.Create<System.Object, System.Int32>(trueItemClass
, 17836), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 17851), Tuple.Create("\"", 17869)
, Tuple.Create(Tuple.Create("", 17859), Tuple.Create<System.Object, System.Int32>(trueTitle
, 17859), false)
);

WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 17870), Tuple.Create("\"", 17911)
, Tuple.Create(Tuple.Create("", 17876), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + "True"
, 17876), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 18181), Tuple.Create("\"", 18204)
, Tuple.Create(Tuple.Create("", 18189), Tuple.Create<System.Object, System.Int32>(falseItemClass
, 18189), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 18205), Tuple.Create("\"", 18224)
, Tuple.Create(Tuple.Create("", 18213), Tuple.Create<System.Object, System.Int32>(falseTitle
, 18213), false)
);

WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 18225), Tuple.Create("\"", 18267)
, Tuple.Create(Tuple.Create("", 18231), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + "False"
, 18231), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 18769), Tuple.Create("\"", 18805)
, Tuple.Create(Tuple.Create("", 18777), Tuple.Create("quiz__explanation", 18777), true)
, Tuple.Create(Tuple.Create(" ", 18794), Tuple.Create<System.Object, System.Int32>(className
, 18795), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 19369), Tuple.Create("\"", 19445)
, Tuple.Create(Tuple.Create("", 19377), Tuple.Create("quiz-block-ordering", 19377), true)
, Tuple.Create(Tuple.Create(" ", 19396), Tuple.Create<System.Object, System.Int32>( context.CanUserFillQuiz ? "" : "not-movable"
, 19397), false)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 19446), Tuple.Create("\'", 19478)
          , Tuple.Create(Tuple.Create("", 19451), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 19451), false)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 20246), Tuple.Create("\'", 20294)
, Tuple.Create(Tuple.Create("", 20251), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + item.GetHash()
, 20251), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 21563), Tuple.Create("\"", 21639)
, Tuple.Create(Tuple.Create("", 21571), Tuple.Create("quiz-block-matching", 21571), true)
, Tuple.Create(Tuple.Create(" ", 21590), Tuple.Create<System.Object, System.Int32>( context.CanUserFillQuiz ? "" : "not-movable"
, 21591), false)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 21640), Tuple.Create("\'", 21672)
          , Tuple.Create(Tuple.Create("", 21645), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 21645), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 22408), Tuple.Create("\"", 22497)
, Tuple.Create(Tuple.Create("", 22416), Tuple.Create("text-success", 22416), true)
, Tuple.Create(Tuple.Create(" ", 22428), Tuple.Create("col-sm-3", 22429), true)
, Tuple.Create(Tuple.Create(" ", 22437), Tuple.Create<System.Object, System.Int32>( model.DebugView ? "col-xs-offset-4" : "col-xs-offset-1"
, 22438), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 22938), Tuple.Create("\"", 22994)
, Tuple.Create(Tuple.Create("", 22946), Tuple.Create("quiz", 22946), true)
, Tuple.Create(Tuple.Create(" ", 22950), Tuple.Create("quiz-block-matching__item", 22951), true)
, Tuple.Create(Tuple.Create(" ", 22976), Tuple.Create<System.Object, System.Int32>(isRightClass
, 22977), false)
, Tuple.Create(Tuple.Create(" ", 22990), Tuple.Create("row", 22991), true)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 23029), Tuple.Create("\'", 23094)
, Tuple.Create(Tuple.Create("", 23034), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + fixedItem.GetHashForFixedItem()
, 23034), false)
);
