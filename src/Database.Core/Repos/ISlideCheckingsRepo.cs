...
namespace Database.Repos
{
	public interface ISlideCheckingsRepo
	{
		...
		Task MarkManualQuizCheckingAsChecked(ManualQuizChecking queueItem, int score, string checkedById);
		Task MarkManualExerciseCheckingAsChecked(ManualExerciseChecking queueItem, int percent, string checkedById);
